...
//	PORT_DIPSETTING(    0x00, "?" )
	...
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_BITX( 0,       0x02, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE )
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, DEF_STR( Free_Play ) )
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
...
ROM_START( willow )
	...
	ROM_LOAD16_BYTE( "willow-u.35",  0x00001, 0x20000, 0x7a791e77 )
...
ROM_START( mswordr1 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "ms30.11f",   0x00000, 0x20000, 0x21c1f078 )
	ROM_LOAD16_BYTE( "ms35.11h",   0x00001, 0x20000, 0xa540a73a )
	ROM_LOAD16_BYTE( "ms31.12f",   0x40000, 0x20000, 0xd7e762b5 )
	ROM_LOAD16_BYTE( "ms36.12h",   0x40001, 0x20000, 0x66f2dcdb )
	ROM_LOAD16_WORD_SWAP( "ms_32.rom",    0x80000, 0x80000, 0x2475ddfc )
...
ROM_START( cawingu )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "cae_30a.rom",  0x00000, 0x20000, 0x91fceacd )
	ROM_LOAD16_BYTE( "cau_35a.rom",  0x00001, 0x20000, 0xf090d9b2 )
	ROM_LOAD16_BYTE( "cae_31a.rom",  0x40000, 0x20000, 0xe5b75caf )
	ROM_LOAD16_BYTE( "cae_36a.rom",  0x40001, 0x20000, 0xc73fd713 )
	ROM_LOAD16_WORD_SWAP( "ca_32.rom", 0x80000, 0x80000, 0x0c4837d4 )
...
ROM_START( sf2ceuc )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "s92-23c",      0x000000, 0x80000, 0x0a8b6aa2 )
	ROM_LOAD16_WORD_SWAP( "s92-22c",      0x080000, 0x80000, 0x5fd8630b )
	ROM_LOAD16_WORD_SWAP( "s92-21b",      0x100000, 0x80000, 0xb383cb1c )
...
ROM_START( dinou )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "cdu.23a",      0x000000, 0x80000, 0x7c2543cd )
	ROM_LOAD16_WORD_SWAP( "cdu.22a",      0x080000, 0x80000, 0xfab740a9 )
	ROM_LOAD16_WORD_SWAP( "cde_21a.rom",  0x100000, 0x80000, 0x66d23de2 )
...
GAME( 1991, kodj,     kod,      cps1,     kod,      cps1,     ROT0,   "Capcom", "The King of Dragons (Japan 910805)" )
...
GAME( 1992, sf2rb,    sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Rainbow set 1)" )	// 920322 - based on World version
GAME( 1992, sf2rb2,   sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Rainbow set 2)" )	// 920322 - based on World version
GAME( 1992, sf2red,   sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Red Wave)" )		// 920313 - based on World version
GAME( 1992, sf2v004,  sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II! - Champion Edition (V004)" )		// "102092" !!! - based on (heavily modified) World version
GAME( 1992, sf2accp2, sf2ce,    sf2,      sf2,      cps1,     ROT0,   "hack",  "Street Fighter II' - Champion Edition (Accelerator Pt.II)" )  // 920313 - based on USA version
