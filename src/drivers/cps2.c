...
ROM_START( 19xx )
	...
	ROM_LOAD16_WORD_SWAP( "19xux.03", XOR_BASE+0x000000, 0x80000, 0x239a08ae )
	ROM_LOAD16_WORD_SWAP( "19xux.04", XOR_BASE+0x080000, 0x80000, 0xc13a1072 )
	ROM_LOAD16_WORD_SWAP( "19xux.05", XOR_BASE+0x100000, 0x80000, 0x8c066ec3 )
	ROM_LOAD16_WORD_SWAP( "19xux.06", XOR_BASE+0x180000, 0x80000, 0x4b1caeb9 )
...
ROM_START( 19xxj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "19xjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "19xjx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "19xjx.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "19xjx.06", XOR_BASE+0x180000, 0x80000, 0x00000000 )
...
ROM_START( 19xxh )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "19xhx.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "19xhx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "19xhx.05a", XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "19xhx.06a", XOR_BASE+0x180000, 0x80000, 0x00000000 )
...
ROM_START( qndream )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "tqzjx.03", XOR_BASE+0x000000, 0x80000, 0x5804a8f8 )
...
ROM_START( slam2e )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "smbex.03b", XOR_BASE+0x000000, 0x80000, 0x3b1457bd )
	ROM_LOAD16_WORD_SWAP( "smbex.04b", XOR_BASE+0x080000, 0x80000, 0x6299eb4e )
	ROM_LOAD16_WORD_SWAP( "smbex.05b", XOR_BASE+0x100000, 0x80000, 0xbe4a84d1 )
...
ROM_START( ssf2 )
	...
	ROM_LOAD16_WORD_SWAP( "ssfux.05",  XOR_BASE+0x100000, 0x80000, 0xaa846b9f )
...
ROM_START( ssf2t )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfxex.03c", XOR_BASE+0x000000, 0x80000, 0xa181b207 )
	ROM_LOAD16_WORD_SWAP( "sfxex.04a", XOR_BASE+0x080000, 0x80000, 0xdf28bd00 )
	ROM_LOAD16_WORD_SWAP( "sfxex.05",  XOR_BASE+0x100000, 0x80000, 0x29b7bda4 )
	ROM_LOAD16_WORD_SWAP( "sfxex.06a", XOR_BASE+0x180000, 0x80000, 0x6c8719b3 )
	ROM_LOAD16_WORD_SWAP( "sfxex.07",  XOR_BASE+0x200000, 0x80000, 0xdfc3b3cd )
	ROM_LOAD16_WORD_SWAP( "sfxex.08",  XOR_BASE+0x280000, 0x80000, 0xd7436ae9 )
...
ROM_START( ssf2tu )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfxux.03c", XOR_BASE+0x000000, 0x80000, 0x441df197 )
	ROM_LOAD16_WORD_SWAP( "sfxux.04a", XOR_BASE+0x080000, 0x80000, 0x7390df1b )
	ROM_LOAD16_WORD_SWAP( "sfxux.05",  XOR_BASE+0x100000, 0x80000, 0x1d3310a0 )
	ROM_LOAD16_WORD_SWAP( "sfxux.06a", XOR_BASE+0x180000, 0x80000, 0x6fc5efa6 )
	ROM_LOAD16_WORD_SWAP( "sfxux.07",  XOR_BASE+0x200000, 0x80000, 0x88455606 )
	ROM_LOAD16_WORD_SWAP( "sfxux.08",  XOR_BASE+0x280000, 0x80000, 0xfa2396a6 )
...
ROM_START( ssf2ta )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfxax.03c", XOR_BASE+0x000000, 0x80000, 0xc8a664fa )
	ROM_LOAD16_WORD_SWAP( "sfxax.04a", XOR_BASE+0x080000, 0x80000, 0x149d6352 )
	ROM_LOAD16_WORD_SWAP( "sfxax.05",  XOR_BASE+0x100000, 0x80000, 0xac169aa9 )
	ROM_LOAD16_WORD_SWAP( "sfxax.06a", XOR_BASE+0x180000, 0x80000, 0xbb60394c )
	ROM_LOAD16_WORD_SWAP( "sfxax.07",  XOR_BASE+0x200000, 0x80000, 0xe62b1b69 )
	ROM_LOAD16_WORD_SWAP( "sfxax.08",  XOR_BASE+0x280000, 0x80000, 0x7c5fd202 )
...
ROM_START( ssf2xj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfxjx.03c", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxjx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxjx.05",  XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxjx.06a", XOR_BASE+0x180000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxjx.07",  XOR_BASE+0x200000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxjx.08",  XOR_BASE+0x280000, 0x80000, 0x00000000 )
...
ROM_START( xmcota )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "xmnux.03e", XOR_BASE+0x000000, 0x80000, 0x27636ac7 )
	ROM_LOAD16_WORD_SWAP( "xmnux.04e", XOR_BASE+0x080000, 0x80000, 0x0aed300c )
...
GAME( 1996, 19xx,     0,       cps2, cps2,    cps2, ROT270_16BIT, "Capcom", "19XX: The War Against Destiny (US 951207)" )
GAMEX(1996, 19xxj,    19xx,    cps2, cps2,    cps2, ROT270_16BIT, "Capcom", "19XX: The War Against Destiny (Japan 951207)", GAME_NOT_WORKING )
GAMEX(1996, 19xxh,    19xx,    cps2, cps2,    cps2, ROT270_16BIT, "Capcom", "19XX: The War Against Destiny (Hispanic 951218)", GAME_NOT_WORKING )
...
GAME( 1994, avsp,     0,       cps2, avsp,    cps2, ROT0_16BIT,   "Capcom", "Alien vs. Predator (US 940520)" )
...
GAMEX(1993, ddtodj,   ddtod,   cps2, ddtod,   cps2, ROT0_16BIT,   "Capcom", "Dungeons & Dragons: Tower of Doom (Japan 940113)", GAME_NOT_WORKING )
...
GAME( 1993, ecofe,    0,       cps2, cps2,    cps2, ROT0_16BIT,   "Capcom", "Eco Fighters (World 931203)" )
...
GAMEX(1995, mshh,     msh,     cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Marvel Super Heroes (Hispanic 951117)", GAME_NOT_WORKING )
...
GAME( 1998, mvsc,     0,       cps2, cps2,    cps2, ROT0_16BIT,   "Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (US 980123)" )
GAME( 1998, mvscj,    mvsc,    cps2, cps2,    cps2, ROT0_16BIT,   "Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (Japan 980123)" )
GAME( 1998, mvsch,    mvsc,    cps2, cps2,    cps2, ROT0_16BIT,   "Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (Hispanic 980123)" )
...
GAMEX(1995, sfzjr2,   sfa,     cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Zero (Japan 950605)", GAME_NOT_WORKING )
...
GAMEX(1996, sfz2,     sfa2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Zero 2 (Japan 960227)", GAME_NOT_WORKING )
GAMEX(1996, sfz2a,    sfa2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Zero 2 Alpha (Japan 960805)", GAME_NOT_WORKING )
GAME( 1998, sfa3,     0,       cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Alpha 3 (US 980629)" )
GAME( 1998, sfz3,     sfa3,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Zero 3 (US 980727)" )
...
GAMEX(1993, ssf2j,    ssf2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Super Street Fighter 2: The New Challengers (Japan 931005)", GAME_NOT_WORKING )
GAMEX(1993, ssf2jr1,  ssf2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Super Street Fighter 2: The New Challengers (Japan 930911)", GAME_NOT_WORKING )
GAMEX(1993, ssf2jr2,  ssf2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Super Street Fighter 2: The New Challengers (Japan 930910)", GAME_NOT_WORKING )
...
GAMEX(1994, ssf2xj,   ssf2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Super Street Fighter 2 X: Grand Master Challenge (Japan 940223)", GAME_NOT_WORKING )
